...
var _user$project$TradingFrontend$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$TradingFrontend$main = _elm_lang$html$Html$program(
	{init: _user$project$State$init, view: _user$project$Views$view, update: _user$project$State$update, subscriptions: _user$project$TradingFrontend$subscriptions})();

var Elm = {};
Elm['TradingFrontend'] = Elm['TradingFrontend'] || {};
if (typeof _user$project$TradingFrontend$main !== 'undefined') {
    _user$project$TradingFrontend$main(Elm['TradingFrontend'], 'TradingFrontend', undefined);
}
